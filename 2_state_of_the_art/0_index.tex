...
Las competencias que se han evaluado han sido prácticamente todas. Aunque las que más se han evaluado son xxx, yyy y zzz ...

\bigskip
\textbf{Q2. ¿Qué métodos se utilizan para evaluar competencias genéricas mediante el uso de entornos virtuales?}

Los métodos que más se utilizan son las rubricas electrónicas, utilizadas tanto por el profesor como por el estudiante. Si el profesor se encarga de la rúbrica la carga de trabajo aumenta. Sin embargo, si se delega en la autoevaluación o evaluación entre iguales se pierde objetividad. Además, algunas competencias son difícilmente evaluables por este método. También se encuentra test psicológicos para la evaluación de algunos alumnos, asi como algunos juegos serios.
...
Obtención de indicadores de los procesos de aprendizaje y el uso de estos indicadores para evaluar competencias genéricas.
