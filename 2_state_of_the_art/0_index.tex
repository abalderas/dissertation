...
\begin{itemize}
\item Evaluación semiautomática: se utiliza una herramienta informática que da formato y sporte a la evaluación pero es el humano el que introduce las calificaciones. 
...
\begin{table}
  ...
  \begin{tabular}{| m{3.5cm} | m{9cm} |}
    ...
    \hline
    Emprendimiento & \cite{chang2009international,marquez2010have,achcaoucaou2014competence} \\
    \hline
    ...
    \hline
    TIC & \cite{lasa2013problem,masip2013self} \\
    \hline
...
En este grupo de trabajos se realizan experiencias utilizando algún tipo de herramienta que favorezca el desarrollo y desempeño de la competencia que se pretende evaluar. Después de la experiencia los alumnos realizan cuestionarios de autoevaluación o evaluación entre compañeros. A continuación se describen las diferentes estrategias encontradas, con los elementos que en ella aparecen y en la tabla~\ref{tab:MetodosAuto} se muestran los trabajos asociados a cada una:
...
\item \emph{Interacción con EVA}: tras haber trabajado los estudiantes en actividades de un EVA se realizan cuestionarios de autoevaluación y evaluación entre iguales para medir su desempeño en diferentes competencias genéricas.
\end{itemize}
...
\begin{table}
  ...
  \begin{tabular}{| m{3.5cm} | m{3.5cm} | m{5.5cm} |}
    ...
    \hline
    Interacción con EVA & Autoevaluación y evaluación entre iguales &  \cite{ficapal2015learning,khamis2012measurement,barbera2011assessment,ruizacarate2013soft,piedra2010measuring,pinto2011assessment,carreras2013promotion} \\
    \hline
  \end{tabular}
\end{center}
...
% 2 \subsubsection{Evaluación del profesor (teacher assessment)}
...
\begin{table}
  ...
  \begin{tabular}{| m{3.5cm} | m{9cm} |}
    ...
    \hline
    \hline
    Comunicación & \cite{martin2013acquired,rodriguez2010portfolio,benlloch2007adapting,yang2014fine,lacuesta2009active} \\
	\hline
    ...
    \hline
    Trabajo en equipo & \cite{martin2013acquired,rodriguez2010portfolio,benlloch2007adapting,lacuesta2009active} \\    
    \hline
  \end{tabular}
\end{center}
...
\begin{table}
  ...
  \begin{tabular}{| m{3.5cm} | m{3.5cm} | m{5.5cm} |}
    ...
    \hline
    Practicas con herramientas empresariales & Profesor &  \cite{ward2011developing} \\
    \hline
    ...
    \hline   
% QUITAR LOS 3 de abajo 
    Rúbricas & Profesor &  \cite{casan2015developing,martin2010new,prashar2010competence} \\
    \hline
  \end{tabular}
\end{center}
...
Desde el punto de vista de las competencias genéricas hemos encontrado dos tipos de herramientas que evalúan automáticamente a los estudiantes: los juegos serios y herramientas que analizan los procesos de aprendizaje. 
