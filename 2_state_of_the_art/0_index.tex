...
Todos los trabajos seleccionados evalúan una o varias competencias genéricas utilizando algún método y sirviéndose de instrumento de evaluación. Para el esquema de clasificación utilizaremos estas tres características para clasificar los trabajos. A continuación vamos a describir cada uno de los valores que pueden tomar estas características.
...
\item Indicadores trabajo en EVA: tras haber trabajado los estudiantes en diferentes actividades del EVA son evaluados del desempeño en diferentes competencias a partir de los registros de interacción de estos estudiantes con el propio EVA.
\end{itemize}

\subsubsection{Instrumentos de evaluación}

Una vez descritos los métodos pasamos a definir los diferentes instrumentos de evaluación:
...
\item Herramientas para el análisis de los registros de aprendizaje (Learning analytics tools): El término \emph{Learning Analytics}, traducido al español como análisis del aprendizaje, es definido por la \emph{Society for Learning Analytics} como la medición, recopilación, análisis y presentación de datos sobre los estudiantes, sus contextos y las interacciones que allí se generan, con el fin de comprender el proceso de aprendizaje que se está desarrollando y optimizar los entornos en los que se produce~\cite{siemens2012learning}.
\end{itemize}
...
A continuación se van a listar primero las competencias que se han evaluado con este enfoque, y segundo con qué herramientas y métodos se han llevado a cabo estas evaluaciones.
...
En~\ref{tab:MetodosAuto} se indican los instrumentos de evaluación y los métodos seguidas por cada uno de los trabajos que sigue este enfoque de autoevaluación y evaluación entre iguales. Los cuestionarios y las rúbricas son los instrumentos de evaluación más utilizados. 

\begin{table}
  \begin{center}
  \begin{tabular}{| c | m{4.5cm} | m{7.5cm} |}
    \hline
    TRABAJO & HERRAMIENTA & MÉTODO \\
    \hline
    \hline
    ...
    \hline
    \cite{arno2011promoting} & Rúbrica & Post-evaluación trabajo en EVA\\
    \hline
    \cite{sevilla2012assessment} & Cuestionario & Post-evaluación trabajo en EVA \\
    \hline
    \cite{ficapal2015learning} & Cuestionario & ABE apoyado en herramientas informáticas \\
    \hline
    \cite{ruizacarate2013soft} & Cuestionario & Post-evaluación trabajo en EVA \\
    \hline
    \cite{piedra2010measuring} & Rúbrica & Post-evaluación trabajo en EVA \\
    \hline
    \cite{carreras2013promotion} & Rúbrica & Post-evaluación trabajo en EVA \\
    \hline
    \cite{martinez2014teamwork} & Cuestionario & ABP apoyado en herramientas informáticas \\
    \hline
    \cite{oliver2013graduate} & Rúbrica & Post-evaluación trabajo en EVA \\
    \hline
  \end{tabular}
\end{center}
...
En la tabla~\ref{tab:MetodosProfesor} puede ver los Métodos que sigue y las herramientas que aplica cada uno de los trabajos que se han recopilado para este tipo de evaluación.
...
\begin{table}
  ...
  \begin{tabular}{| c | m{4.5cm} | m{6.5cm} |}
    ...
    \hline
    \cite{martin2013acquired} & Rúbrica & Post-evaluación trabajo en EVA \\
    \hline
    \cite{rodriguez2010portfolio} & Rúbrica & Post-evaluación trabajo en EVA  \\
    \hline
    \cite{benlloch2007adapting} & Herramienta de seguimiento & Post-evaluación trabajo en EVA \\
    \hline
    \cite{yang2014fine} & Actividades sin determinar  & Implementación modelo matemático itinerario aprendizaje \\
    \hline
    \cite{serrano2013hiperion} & Actividades sin determinar  & Post-evaluación trabajo en EVA \\
    \hline
    \cite{starcic2008sustaining} & Actividades sin determinar  & Post-evaluación trabajo en EVA \\
    \hline
    \cite{vizcarro2013assessment} & Cuestionario  & Post-evaluación trabajo en EVA \\
    \hline
...
\bigskip
\textbf{Instrumentos de evaluación y métodos}
\bigskip

En esta sección se muestran diferentes herramientas para la evaluación automática de competencias genéricas (tabla~\ref{tab:MetodosAutomaticos}). Nos encontramos con tres métodos nuevos: test psicológico definido por expertos, indicadores basados en logros conseguidos en el juego e indicadores trabajo en EVA.

\begin{table}
  \begin{center}
  \begin{tabular}{| c | m{4.5cm} | m{6.5cm} |}
    \hline
    TRABAJO & HERRAMIENTA & MÉTODOS \\
    \hline
    \hline
    ...
    \hline
    \cite{rayon2014web} & Herramienta para el análisis de los registros de aprendizaje  & Indicadores trabajo en EVA \\
    \hline
    \cite{fidalgo:2015} & Herramienta para el análisis de los registros de aprendizaje & Indicadores trabajo en EVA \\
    \hline
  \end{tabular}
\end{center}
...
Dentro de los trabajos que utilizan un método de evaluación automática hay dos trabajos que utilizan los registros de actividad de los entornos virtuales para la evaluación de competencias~\cite{rayon2014web,fidalgo:2015}. 
...
\begin{table}
  ...
  \begin{tabular}{| c | c | c |}
    \hline
     \multirow{2}{*}{\textbf{Competencias}} & \textbf{Métodos} & \multirow{2}{*}{\textbf{Técnicas}} \\
    \cline{2-2}
     &  Indicadores trabajo en EVA & \\
    \hline
    \hline
