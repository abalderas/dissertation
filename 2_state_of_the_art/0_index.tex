...
En \cite{yang2014fine} se define un modelo de itinerario de aprendizaje que soporta la evaluación de algunos conocimientos y competencias para describir el progreso de aprendizaje del estudiante. El modelo se define matemáticamente para poder formalmente definir las evaluaciones y para poder reutilizar las fórmulas. Aunque se reconoce las ventajas de un sistema que automatice este proceso, hasta el momento son los profesores los que evalúan a sus estudiantes en cada una de sus etapas, asi como su reticencia a un sistema 100\% automático. Las competencias de \emph{comunicación} y \emph{escritura} se evalúan en este trabajo.

En \cite{martin2013acquired} los profesores evalúan el desempeño de los estudiantes en las competencias de \emph{trabajo en equipo} y \emph{comunicación oral y escrita} mediante diferentes herramientas en una evaluación continua, entre ellas el e-portfolio. En \cite{martin2010new} y en \cite{prashar2010competence} los profesores siguen una metodología de evaluación continua para evaluar las competencias de \emph{trabajo en equipo} y \emph{comunicación oral y escrita}. Establecen una serie de indicadores que les permiten monitorizar el progreso de los estudiantes. Mediante un e-portfolio también se evalúan competencias genéricas en \cite{rodriguez2010portfolio}. En concreto 

En \cite{serrano2013hiperion} se diseña \emph{Hiperion}, una sistema de recomendación que ayuda a diseñar actividades adaptadas a cada estudiante para mejorar sus competencias. En el estudio de caso mostrado los profesores evaluaban las competencias de los estudiantes manualmente y después aplicaban Hiperion. El principal desventaja de la herramienta es el tiempo que el profesor ha sw dedicar para asignar los diferentes logros y el peso de cada nota para cada competencia en las actividades.

En \cite{casan2015developing} el profesor se encarga de la evaluación en las habilidades de \emph{escritura} de los estudiantes mediante el uso de unas rubricas. En concreto se evalúan las competencias de \emph{comunicación escrita}, \emph{comunicación oral}, \emph{toma de decisiones} y \emph{uso eficiente de las fuente de información}.

En \cite{ward2011developing} se desarrollan una serie de módulos para Moodle para el desarrollo de competencias empresariales. Los alumnos realizan una serie de actividades para cada módulo y el profesor evalúa mediante conferencia via Skype si el estudiante sabe lo que ha respondido.


En \cite{lacuesta2009active} también se utiliza una metodología ABP, dónde se realiza una evaluación individualizada de cada estudiante y de cada grupo de estudiantes. El esfuerzo necesario y carga de trabajo para cada profesor es el mismo, o en todo caso, sólo un poco mayor al habitual. Se evaluan competencias como la \emph{capacidad critica}, \emph{trabajo en equipo}, \emph{planificación}, \emph{comunicación}, etc.

En  \cite{benlloch2007adapting} se evaluan las competencias de trabajo en equipo, solución de problemas o habilidades de comunicación, entre otras, mediante diferentes actividades como exámenes, cuestionarios y e-portfolio
