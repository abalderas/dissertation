...
\begin{table}
  ...
  \begin{tabular}{| m{3cm} | m{3cm} | m{3.5cm} | m{2cm} |} % {| m{2cm} | m{4.5cm} | m{3cm} | m{2.5cm} |}   
    \hline
    MÉTODO DE EVALUACIÓN & TÉCNICA DE EVALUACIÓN & INSTRUMENTO DE EVALUACIÓN & TRABAJOS \\
    \hline
    \hline
    \multirow{3}{*}{Auténtica} & Actividades sin determinar  & - & \cite{renau2010teaching} \\
    \cline{2-4}
...
\begin{table}
  ...
  \begin{tabular}{| m{3cm} | m{3cm} | m{3.5cm} | m{2cm} |}
    ...
    \hline
    \hline
     Auténtica & \multirow{2}{3.5cm}{Actividades sin determinar} & \multirow{2}{*}{-}  & \cite{starcic2008sustaining} \\
    \cline{1-1} \cline{4-4}
     Con referencia al criterio &  &   & \cite{serrano2013hiperion} \\
    \hline
     \multirow{3}{*}{Formativa} & Pruebas orales & Entrevista & \cite{ward2011developing} \\
    \cline{2-4}
     & \multirow{3}{3.5cm}{Observación sistemática } & Herramienta de seguimiento & \cite{benlloch2007adapting,lacuesta2009active} \\
    \cline{3-4}
      &  & \multirow{2}{*}{Rúbrica} & \cite{rodriguez2010portfolio} \\
    \cline{1-1} \cline{4-4}
     \multirow{3}{*}{Sumativa} &    &  & \cite{aziz2007appraisal,martin2013acquired,rashid2008engineering} \\
    \cline{2-4}
      & Actividades sin determinar & -  & \cite{yang2014fine} \\
    \cline{2-4}
...
\begin{table}
  ...
  \begin{tabular}{| c | m{3.5cm} | m{5cm} | m{4cm} |}
    ...
    \hline
    \cite{guenaga2013serious}  & GBL & Indicadores basados en logros & Juegos serios \\
    \hline
    \cite{bedek2011behavioral}  & GBL  & Indicadores basados en logros & Juegos serios  \\
    \hline
    \cite{rayon2014web} & Learning Analytics & Indicadores de trabajo en VLE & Herramienta para el análisis de los registros de aprendizaje \\
    \hline
    \cite{fidalgo:2015} & Learning Analytics & Indicadores de trabajo en VLE & Herramienta para el análisis de los registros de aprendizaje \\
    \hline
  \end{tabular}
\end{center}
...
\begin{table}
  ...
  \begin{tabular}{| c | c | c |}
    ...
    \cline{2-3}
     &  Indicadores de trabajo en VLE & Learning Analytics \\
    \hline
    \hline
