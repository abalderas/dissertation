...
\begin{table}
  ...
  \begin{tabular}{| c | m{4.5cm} | m{6.5cm} |}
    ...
    \hline
    \cite{rayon2014web} & Herramienta para el análisis de los registros de aprendizaje  & Trabajo en herramientas del EVA \\
    \hline
    \cite{fidalgo:2015} & Herramienta para el análisis de los registros de aprendizaje & Trabajo en herramientas del EVA \\
    \hline
  \end{tabular}
\end{center}
...
En~\cite{fidalgo:2015} se utilizan técnicas de minería de datos (del inglés, \emph{data mining}) mediante el desarrollo de un servicio web en Moodle que devolviera información almacenada en los registros en la plataforma de aprendizaje.
