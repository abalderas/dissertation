...
\ptitle{\emph{Proponer un método para evaluar a los estudiantes en el desempeño de sus competencias genéricas mediante indicadores procedentes de los registros de actividades de aprendizaje.}}
...
Conjunto de técnicas que se aplican en los trabajos encontrados:
...
\ptitle{Métodos, Técnicas e instrumentos de evaluación}
...
\ptitle{Q1. ¿Qué competencias se han evaluado de forma \, automática o asistida por ordenador  a partir de  \, la actividad de los estudiantes en los entornos virtuales?}
...
\ptitle{Q2. ¿Qué métodos se utilizan para evaluar competencias genéricas mediante el uso de entornos virtuales?}
...
\ptitle{Q3. ¿Qué técnicas se utilizan para evaluar competencias genéricas a partir de los registros de actividad de un entorno virtual?}
