...
%El enfoque de este trabajo se centra en los LMS. En ellos cada archivo, cada acceso o cada tarea hecha por un estudiante queda registrado en el sistema. Los investigadores utilizan a menudo el registro de interacción de los alumnos con el sistema para responder a diferentes cuestiones de investigación relacionadas con los procesos de adquisición del conocimiento, el diseño de escenarios pedagógicos o para analizar la usabilidad de las herramientas ~\cite{Chebil:2012}. Los modelos basados en la actividad del alumno pueden proporcionar evidencias para la evaluación de competencias. Sin embargo, la información de registro que el profesor puede obtener del LMS necesita ser procesada antes de poder ser utilizada ~\cite{Florian:2011}.
