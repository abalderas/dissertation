...
\subparagraph*{Hipótesis inicial (Iteración II).}
...
\subparagraph*{Diseño y formulación de la evaluación (Iteración II).}

El profesor diseña la consulta \ref{code:sasqlejemplo2} en SASQL.
